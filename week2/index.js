...
let g = 8;
let h = '8';
console.log(g * h == 88); // false, 64 != 88
console.log(g * h == 64); // true
console.log(g * h === 64);// true, (number * string) = number

let i = '9';
let j = '9';
console.log(i + j == 99);     // true
console.log(i + j === '99');  // true
console.log(i + j === 99);    // false, string != number

var k = 3;
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // true, (number * string) = number, 3 * 8 = 24
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += ((30*activities.runPerMin) + (40*activities.yogaPerMin) + (2*10*activities.bikePerMin));
...
for(let i = 0; i<exerciseRecords.length; i++){
  for(let j = 0; j<days.length; j++){
    if(exerciseRecords[i].day === days[j]){
